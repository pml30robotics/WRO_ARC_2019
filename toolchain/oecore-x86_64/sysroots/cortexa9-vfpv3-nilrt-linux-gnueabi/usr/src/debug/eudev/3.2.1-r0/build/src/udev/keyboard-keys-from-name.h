...
/* Command-line: /mnt/build/jenkins-jobs/nilrt_OE_toolchain-cobra/workspace/build/tmp-glibc/work/cortexa9-vfpv3-nilrt-linux-gnueabi/eudev/3.2.1-r0/recipe-sysroot-native/usr/bin/gperf -L ANSI-C -t -N keyboard_lookup_key -H hash_key_name -p -C  */
