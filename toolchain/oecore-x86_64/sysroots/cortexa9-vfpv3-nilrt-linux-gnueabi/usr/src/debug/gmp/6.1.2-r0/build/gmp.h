...
#define __GMP_CC "arm-nilrt-linux-gnueabi-gcc  -march=armv7-a -mfpu=vfpv3  -mfloat-abi=softfp -mcpu=cortex-a9 --sysroot=/mnt/build/jenkins-jobs/nilrt_OE_toolchain-cobra/workspace/build/tmp-glibc/work/cortexa9-vfpv3-nilrt-linux-gnueabi/gmp/6.1.2-r0/recipe-sysroot"
#define __GMP_CFLAGS "-O2 -pedantic -fomit-frame-pointer  -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/mnt/build/jenkins-jobs/nilrt_OE_toolchain-cobra/workspace/build/tmp-glibc/work/cortexa9-vfpv3-nilrt-linux-gnueabi/gmp/6.1.2-r0=/usr/src/debug/gmp/6.1.2-r0 -fdebug-prefix-map=/mnt/build/jenkins-jobs/nilrt_OE_toolchain-cobra/workspace/build/tmp-glibc/work/cortexa9-vfpv3-nilrt-linux-gnueabi/gmp/6.1.2-r0/recipe-sysroot-native= -fdebug-prefix-map=/mnt/build/jenkins-jobs/nilrt_OE_toolchain-cobra/workspace/build/tmp-glibc/work/cortexa9-vfpv3-nilrt-linux-gnueabi/gmp/6.1.2-r0/recipe-sysroot= "
