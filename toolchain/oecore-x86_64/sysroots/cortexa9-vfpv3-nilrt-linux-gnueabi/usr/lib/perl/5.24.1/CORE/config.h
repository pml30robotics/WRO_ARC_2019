 ...
 */
#define CPPSTDIN "arm-nilrt-linux-gnueabi-gcc  -march=armv7-a -mfpu=vfpv3  -mfloat-abi=softfp -mcpu=cortex-a9  -E"
#define CPPMINUS "-"
#define CPPRUN "arm-nilrt-linux-gnueabi-gcc  -march=armv7-a -mfpu=vfpv3  -mfloat-abi=softfp -mcpu=cortex-a9  -E"
#define CPPLAST "-"
